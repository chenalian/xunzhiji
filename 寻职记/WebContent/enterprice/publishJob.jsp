...
<body onload="setup();preselect('江苏省');promptinfo();">
	...
	<ul class="nav nav-tabs">
	  ...
	  <li><a href=""><span class="glyphicon glyphicon-pencil">发布工作</span></a></li>
			...
			<tr height="600px">
				...
				<td width="70%" >
						<div class="center-block" align="center" style="font-size:30px;">
							<form role="form" action="../PublishJob" method="post">
								<div class="form-group">
									<lable for="qid">企业id:</lable>
									<input type="type" name="qid" value="${uid}" readonly="readonly"/>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<lable for="qid">岗位:</lable>
									<input type="text" name="post" />
								</div>
								
								<div class="form-group">
									<lable for="qid">岗位要求:</lable>
									<input type="text" name="postneed" />
								</div>
								
								<div class="form-group">
									<lable for="qid">地址:</lable>
								...
								<div class="form-group">
									<lable for="qid">月薪水:</lable>
									<input type="text" name="salary" />
								</div>
								
								<div class="form-group">
									<lable for="qid">开始时间:</lable>
									<input type="text" name="stime" />
								</div>
								
								<div class="form-group">
									<lable for="qid">截止时间:</lable>
									<input type="text" name="etime" />
								</div>
								
								<div class="form-group">
									<lable for="qid">人数限制:</lable>
									<input type="text" name="nsm" />
								</div>
