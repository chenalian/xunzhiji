...
<body onload="setup();preselect('江苏省');promptinfo();">
	<!-- 企业图片可以为空，后期可以修改 -->
	<form action="../Addenterprice" method="post" enctype="multipart/form-data">
  ...
  <tr>
      ...
      <td><input type="text" name="uid" class="bule"/></td>
      <td class="font1">不超过7个汉字，或14个字节（数字，字母和下划线）</td>
  </tr>
  <tr>
     <td><b>密码：  </b></td>
     <td>
      <input type="password" name="upwd" size="20"class="bule"/></td>
  ...
  <!-- </tr> -->
  <tr>
      <td width="80"><b>营业执照：</b></td>
      <td><input type="text" name="ulicense" class="bule"/></td>
      <td></td>
  </tr>
  
  <tr>
      <td><b>企业名称：</b></td>
     <td><input type="text" name="uname" class="bule"/></td>
