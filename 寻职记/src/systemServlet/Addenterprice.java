...
public class Addenterprice extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String ulicense=null;// 营业执照
		String uname = null;// 企业名字
		
		
		String uaddr = null;// 企业地址
		// 分段获取
		
		
		String utel= null; // 企业带年华
		String umail= null;// 企业邮箱
		String ujianjie= null ;// 企业简介
...
//						File temp=new File("../images"+ (String) request.getSession().getAttribute("uid")+".png");
		...
		if(result)System.out.println("提交企业信息成功");
		else System.out.println("提交企业信息失败");
