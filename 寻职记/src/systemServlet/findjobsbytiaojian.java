...
public class findjobsbytiaojian extends HttpServlet {	
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		else if(tiaojian.equals("月薪"))
		{
			...
			// 表示1在前 0在后面排序好 在进行查询
			Object object[]= {Integer.parseInt(request.getParameter("money1")),Integer.parseInt(request.getParameter("money2"))};
